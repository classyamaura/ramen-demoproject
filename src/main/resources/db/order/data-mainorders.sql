...
INSERT INTO order_details (order_id, item_name, quantity) SELECT order_id, '麺B', 10 FROM mainorders WHERE store_name = '店舗3' AND person_in_charge = '担当者C' ORDER BY order_id DESC LIMIT 1;
